     ...
     <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
           ...
           <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
             ...
             {selectedFile ? (
               <>
                 ...
                 {convertedFile && (
                   <div className="mb-4 p-2 text-green-700 text-xs sm:text-sm rounded-md ">
                     <p>Conversion successful!</p>
                     <button
                       onClick={() => handleDownload(convertedFile)}
                       className="text-green-600 hover:bg-green-100 mt-1 p-4 bg-green- rounded-full border-spacing-0.5 border-black shadow-2xl border-b-1 cursor-pointer  "
                     >
       ...
       <div className="mt-6 sm:mt-8">
         ...
         <div className="bg-white p-4 rounded-lg text-xs sm:text-sm text-gray-600 shadow-sm">
           ...
           <p>
             All conversions are processed securely at your browser local
             storage
           </p>

...
const Footer = () => {
  return (
    <footer className="bg-[#574964] text-white py-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl text-[#FFDAB3] font-stretch-condensed ">
              ConvertSign
            </h2>
            <p className="text-[#FFDAB3] font-stretch-condensed text-sm mt-1">
          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="mb-2">
              <p className="text-[#FFDAB3] font-stretch-condensed tet-xl ">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-[#FFDAB3] font-stretch-condensed hover:text-white"
              >
